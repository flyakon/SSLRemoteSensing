...
config=dict(
    ...
    inpainting_head_cfg=dict(
        ...
        out_channels=3,
        img_size=img_size,
        feat_channels=(512,256,128,64,32)
    ),
    agr_head_cfg=dict(
        name='AGPHead',
        in_channels=512,
    ...
    train_cfg=dict(
        ...
        checkpoints=dict(
            checkpoints_path=r'checkpoints/checkpoints_vgg16_inpainting_agr_examplar_total',
            save_step=1,
        ),
        lr_schedule=dict(
            name='stepLR',
        ...
        log=dict(
            log_path=r'log/log_vgg16_inpainting_agr_examplar_total',
            log_step=50,
            with_vis=False,
            vis_path=r''
        ),
